      ...
      <div className="relative w-full max-w-md mx-auto z-10">
        ...
        <div className="flex flex-col items-center mb-6 sm:mb-8">
          ...
          <p className="text-center text-sm sm:text-base text-white/80">
            {isLogin ? 'Welcome back to AttendIQ' : 'Join AttendIQ and streamline your attendance'}
          </p>
        </div>
      </div>
            ...
            <form className="space-y-5 sm:space-y-6" onSubmit={loginForm.handleSubmit(onLoginSubmit)}>
              <div>
                ...
                {loginForm.formState.errors.email && (
                  <p className="mt-2 text-xs sm:text-sm text-red-600 font-medium">{loginForm.formState.errors.email.message}</p>
                )}
              </div>
              ...
              <div>
                ...
                {loginForm.formState.errors.password && (
                  <p className="mt-2 text-xs sm:text-sm text-red-600 font-medium">{loginForm.formState.errors.password.message}</p>
                )}
              </div>
